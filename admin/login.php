...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['email']) || empty($_POST['password'])) {
        // display error message if the input field are empty but the login button was clicked
...
<div class="login-box">
	<div class="login-logo">
  	...
  	<div class="login-box-body">
        ...
        <!-- form for submitting login crediatials for admin -->
