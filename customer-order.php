...
if(!isset($_SESSION['customer'])){
    ...
    //if customer is logged in, but admin has inactiveted him, then force logout this user
    $statement = $pd->prepare("SELECT * FROM tbl_customer WHERE cust_id = ? AND cust_status = ?");
        ...
        <div class = "container">
            ...
            ?>
                                ...
                                foreach ($result as $row) {
                                    ...
                                    <!-- a table to display the ordered products or order history -->
                                    <tr>
                                        <td><?php echo $tip; ?></td>
                                        <td>
                                            <?php
                                            ...
                                            foreach ($result1 as $row1) {
                                                ...
                                                echo '<br>Unit Price: MWK '.number_format($row1['unit_price'], 2);
                                                echo '<br><br>';
                                            }
                                            ?>
                                        </td>
                                        ...
                                        <td><?php echo 'MWK '.number_format($row['paid_amount'], 2); ?></td>
